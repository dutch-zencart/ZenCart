 ...
 * @version $Id: checkout_success.php 5407 2006-12-27 01:35:37Z bjarnetenharkel $
...
define('TEXT_SEE_ORDERS', 'Uw bestelhistorie kunt u zien door naar <a href="' . zen_href_link(FILENAME_ACCOUNT, '', 'SSL') . '">Mijn account</a> te gaan en vervolgens te klikken op "alle bestellingen weergeven".');
define('TEXT_CONTACT_STORE_OWNER', 'Voor al uw vragen kunt u contact opnemen met onze <a href="' . zen_href_link(FILENAME_CONTACT_US) . '">klantenservice</a>.');
