...
// Beheerder configureerbare opties
  ...
  if (MODULE_PAYMENT_AUTHORIZENET_AIM_STATUS == 'True') {
    define('MODULE_PAYMENT_AUTHORIZENET_AIM_TEXT_DESCRIPTION', '<a target="_blank" href="https://account.authorize.net/">Authorize.net handelaren login</a>' . (MODULE_PAYMENT_AUTHORIZENET_AIM_TESTMODE != 'Production' ? '<br /><br />Test informatie:<br /><b>Automatische geaccepteerde creditcard nummers::</b><br />Visa#: 4007000000027<br />MC#: 5424000000000015<br />Discover#: 6011000000000012<br />AMEX#: 370000000000002<br /><br /><b>NB:</b> Deze creditcard nummers worden in productiemodus niet geaccepteerd en in de testmodes wel. Elke toekomstige datum kan worden gebruikt als vervaldatum en elk 3 of 4 cijferig nummer (AMEX) kan worden gebruikt als CVV code.<br /><br /><b>Automatisch afgewezen creditcard nummer:</b><br /><br />Kaartnr.: 4222222222222<br /><br />Dit kaartnummer kan worden gebruikt om berichten van \'afwijzing\' te testen.<br /><br />' : ''));
  } else {
 define('MODULE_PAYMENT_AUTHORIZENET_AIM_TEXT_DESCRIPTION', '<a target="_blank" href="http://reseller.authorize.net/application.asp?id=131345">Klik hier om een account aan te vragen</a><br /><br /><a target="_blank" href="https://account.authorize.net/">Authorize.net handelaren site</a><br /><br /><strong>Benodigd:</strong><br /><hr />*<strong>Authorize.net account</strong> (zie bovenstaande link om u aan te melden)<br />*<strong>CURL is benodigd </strong>en dient VERPLICHT gecompileerd te worden met SSL ondersteuning voor PHP (laat dit doen door uw webhosting bedrijf)<br />*<strong>Authorize.net gebruikersnaam en transactie sleutel</strong>, kan u vinden in uw handelaren profiel. ');
  }
...
// Catalogus
  ...
  define('MODULE_PAYMENT_AUTHORIZENET_AIM_TEXT_CREDIT_CARD_NUMBER', 'Creditcard nummer:');
