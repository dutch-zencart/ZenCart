...
define('TEXT_INSTRUCTIONS','<u>Instructies</u><br />You can use this page to export your Zen Cart&trade; Admin User Access Activity to a CSV file for archiving.<br />You should save this data for use in fraud investigations in case your site is compromised. This is a requirement for PCI Compliance.<br />
