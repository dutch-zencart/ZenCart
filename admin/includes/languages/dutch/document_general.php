...
define('TEXT_PRODUCTS_QTY_BOX_STATUS_OFF', 'Nee, toon de voorraad NIET');
...
// Products and Opties Copy Options
  ...
  define('TEXT_INFO_CURRENT_PRODUCT', 'Huidig artikel: ');
...
define('TEXT_PRODUCTS_QTY_BOX_STATUS_PREVIEW','<strong>Waarschuwing</strong>: Laat geen voorraad zien, standaard ingesteld op 1');
  ...
  define('TEXT_PRODUCTS_QUANTITY_MAX_RETAIL','Maximum bestelhoeveelheid:');

  define('TEXT_PRODUCTS_QUANTITY_MAX_RETAIL_EDIT','0 = onbeperkt, v.a. 1 = maximum besteleenheid');
...
// meta tags
  ...
  define('TEXT_PRODUCTS_METATAGS_PRODUCTS_NAME_STATUS','<strong>Naam document:</strong>');
