...
define('ERROR_CANNOT_ADD_PRODUCT_TYPE','<strong>Foutmelding</strong>Dit artikelsoort kan niet aan deze categorie worden toegevoegd. Kijk de restrictie van deze categorie na.');
...
// Metatags
  ...
  define('TEXT_EDIT_CATEGORIES_META_TAGS_INTRO', 'Definieeer Custom Meta Tags');
