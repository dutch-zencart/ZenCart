...
define('WARNING_PRIMARY_SERVER_FAILED', '<strong>Waarschuwing</strong>: De primaire server voor wisselkoersen (%s) is niet bereikt voor %s (%s) - Probeer de secondaire server.');
