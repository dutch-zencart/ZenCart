 ...
 * @version $Id: dutch translation Zencart v1.3.5 2006-09-04 by joostvdl (based on):  dutch translation Zencart v1.3.01 2006-04-25  by rik (based on):  banner_manager.php 3131 2006-03-07 22:53:04Z ajeh $
*/
...
define('TABLE_HEADING_BANNER_ON_SSL', 'Toon SSL');
...
define('ERROR_BANNER_TITLE_REQUIRED', '<strong>Foutmelding</strong>: naam van de banner is nodig.');
define('ERROR_BANNER_GROUP_REQUIRED', '<strong>Foutmelding</strong>: banner moet aan groep worden toegewezen.');
define('ERROR_IMAGE_DIRECTORY_DOES_NOT_EXIST', '<strong>Foutmelding</strong>: directory bestaat niet: %s');
define('ERROR_IMAGE_DIRECTORY_NOT_WRITEABLE', '<strong>Foutmelding</strong>: directory heeft geen schrijfrechten: %s');
define('ERROR_IMAGE_DOES_NOT_EXIST', '<strong>Foutmelding</strong>: afbeelding komt niet voor.');
define('ERROR_IMAGE_IS_NOT_WRITEABLE', '<strong>Foutmelding</strong>: afbeelding kan niet worden verwijderd.');
define('ERROR_UNKNOWN_STATUS_FLAG', '<strong>Foutmelding</strong>: onbekende optie instelling.');
define('ERROR_BANNER_IMAGE_REQUIRED', '<strong>Foutmelding</strong>: afbeelding bij banner is nodig.');

define('ERROR_GRAPHS_DIRECTORY_DOES_NOT_EXIST', '<strong>Foutmelding</strong>: grafieken directory bestaat niet.Maak een grafieken directory. Voorbeeld: <strong>' . DIR_WS_ADMIN . 'images/grafieken</strong>');
define('ERROR_GRAPHS_DIRECTORY_NOT_WRITEABLE', '<strong>Foutmelding</strong>: grafieken directory heeft geen schrijfrechten. Deze directory bevindt zich in: <strong>' . DIR_WS_ADMIN . 'images/grafieken</strong>');
...
define('IMAGE_ICON_BANNER_ON_SSL_ON','Toon op beveiligde pagina (SSL) - AAN');
define('IMAGE_ICON_BANNER_ON_SSL_OFF',' Toon op beveiligde pagina (SSL) - UIT');
