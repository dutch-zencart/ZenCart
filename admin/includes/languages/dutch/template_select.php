...
define('TEXT_INFO_TEMPLATE_NAME', 'Naam template');
define('TEXT_INFO_LANGUAGE_NAME', 'Taal');
define('TEXT_INFO_TEMPLATE_VERSION', 'Versie: ');
define('TEXT_INFO_TEMPLATE_AUTHOR', 'Eigenaar: ');
define('TEXT_INFO_TEMPLATE_DESCRIPTION', 'Beschrijving: ');
