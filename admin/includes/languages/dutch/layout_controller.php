...
define('TEXT_BAD_BOX','<font color="ff0000"><strong>ONTBREEKT</strong></font><br />');


// Success message
define('SUCCESS_BOX_DELETED','<strong>Met succes</strong> verwijderd van de template van sidebox: ');
