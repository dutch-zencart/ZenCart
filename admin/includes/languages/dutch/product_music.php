...
define('TEXT_DELETE_PRODUCT_INTRO', 'Weet je zeker dat je dit artikel wilt verwijderen?<br /><br /><strong>Waarschuwing:</strong> bij gekoppelde artikelen:<br />1 zorg dat de hoofdcategorie is veranderd als je dit artikel daar vandaan wordt verwijderd<br />2 Markeer onderstaande "checkbox" van de categorie om het artikel uit deze categorie te verwijderen.</li></ol>');
...
// Products and Attribute Copy Options
  ...
  define('TEXT_COPY_ATTRIBUTES','Kopieer optie van artikel naar duplicaat?');
