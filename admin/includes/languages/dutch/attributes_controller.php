 ...
 * @version $Id: dutch translation Zencart v1.3.5 2006-09-04 by joostvdl (based on):   dutch translation Zencart v1.3.0.1 2006-04-29  by rik (based on):  attributes_controller.php 2830 2006-01-10 17:13:18Z birdbrain $
 */
...
define('TEXT_PRICES_AND_WEIGHTS', 'Prijs &amp; gewicht');
...
define('TABLE_TEXT_MAX_COUNT_SHORT', 'Max:');
  ...
  define('TABLE_HEADING_OPTION_VALUE_SIZE','Grote');
  ...
  define('TEXT_OPTION_VALUE_SIZE','Toon grote: ');
  ...
  define('TEXT_INFO_ATTRIBUTES_FEATURES_COPY_TO_PRODUCT','Kopieër opties, naar een ander <strong>artikel</strong>, van artikel ID');
