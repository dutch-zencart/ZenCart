...
define('TEXT_DELETE_WARNING_CHILDS', '<strong>Waarschuwing: </strong>er zijn nog steeds %s subcategorieën gekoppeld aan deze categorie!');
define('TEXT_DELETE_WARNING_PRODUCTS', '<strong>Waarschuwing: </strong>er zijn nog steeds %s artikelen gekoppeld aan deze categorie!');

define('TEXT_MOVE_PRODUCTS_INTRO', 'Kies de categorie waar <strong>%s</strong> opgeslagen moet worden.');
define('TEXT_MOVE_CATEGORIES_INTRO', 'Kies de categorie waar <strong>%s</strong> opgeslagen moet worden.');
define('TEXT_MOVE', 'Verplaats <strong>%s</strong> naar:');
...
define('TEXT_PRODUCTS_QTY_BOX_STATUS_OFF', 'Nee');
...
// Products and Attributes Copy Options
  ...
  define('TEXT_PRODUCTS_QUANTITY_MAX_RETAIL_EDIT','0 = onbeperkt, v.a. 1 = maximum aantal bestelhoeveelheid');
