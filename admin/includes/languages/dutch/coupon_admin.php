...
define('NOTICE_EMAIL_SENT_TO', '<strong>Opmerking:</strong> e-mail verstuurd aan: %s');
define('ERROR_NO_CUSTOMER_SELECTED', '<strong>Foutmelding</strong>: geen klant geselecteerd.');
define('ERROR_NO_SUBJECT', '<strong>Foutmelding</strong>: geen onderwerp ingevuld.');
...
define('COUPON_AMOUNT_HELP', 'De korting die deze bon geeft. Dit kan een vast bedrag zijn (bijv. €5) of percentage (bijv. 3%) op het eindbedrag.');
